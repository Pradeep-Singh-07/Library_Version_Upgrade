...
function useFormik(_a) {
    var _b = _a.validateOnChange, validateOnChange = _b === void 0 ? true : _b, _c = _a.validateOnBlur, validateOnBlur = _c === void 0 ? true : _c, _d = _a.isInitialValid, isInitialValid = _d === void 0 ? false : _d, _e = _a.enableReinitialize, enableReinitialize = _e === void 0 ? false : _e, rest = tslib_1.__rest(_a, ["validateOnChange", "validateOnBlur", "isInitialValid", "enableReinitialize"]);
    ...
    var runValidationAsEffect = React.useCallback(function () {
        var _a = makeCancelable(validateForm(state.values)), validate = _a[0], cancel = _a[1];
