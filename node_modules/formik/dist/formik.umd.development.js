    ...
    ***************************************************************************** */
    ...
    function useFormik(_a) {
      var _b = _a.validateOnChange,
          ...
          _e = _a.enableReinitialize,
          enableReinitialize = _e === void 0 ? false : _e,
          rest = __rest(_a, ["validateOnChange", "validateOnBlur", "isInitialValid", "enableReinitialize"]);
      ...
      var _f = React.useReducer(formikReducer, {
      ...
      var runValidationAsEffect = React.useCallback(function () {
      ...
      React.useEffect(function () {
        if (enableReinitialize && isMounted.current && !reactFastCompare(initialValues.current, props.initialValues)) {
      ...
      function validateField(name) {
        if (fields.current !== null && fields.current[name] && fields.current[name].validate && isFunction$1(fields.current[name].validate)) {
      ...
      function runFieldLevelValidations(values) {
        ...
        var fieldKeysWithValidation = Object.keys(fields.current).filter(function (f) {
          return fields.current !== null && fields.current[f] && fields.current[f].validate && isFunction$1(fields.current[f].validate);
        });
      ...
      var isValid = React.useMemo(function () {
        return dirty ? state.errors && Object.keys(state.errors).length === 0 : isInitialValid !== false && isFunction$1(isInitialValid) ? isInitialValid(props) : isInitialValid;
    ...
    function Formik(props) {
      ...
      return React.createElement(FormikProvider, {
        value: formikbag
      }, component ? React.createElement(component, formikbag) : render ? render(formikbag) : children ? isFunction$1(children) ? children(formikbag) : !isEmptyChildren(children) ? React.Children.only(children) : null : null);
    }
    ...
    function Field(_a) {
      var validate = _a.validate,
          ...
          _b = _a.as,
          is = _b === void 0 ? 'input' : _b,
          component = _a.component,
          props = __rest(_a, ["validate", "name", "render", "children", "as", "component"]);
      ...
      warning(!!is && !!children && isFunction$1(children), 'You should not use <Field as> and <Field children> as a function in the same <Field> component; <Field as> will be ignored.');
      warning(!!component && children && isFunction$1(children), 'You should not use <Field as> and <Field children> as a function in the same <Field> component; <Field as> will be ignored.');
      ...
      var _d = formik.getFieldProps(name, props.type),
          field = _d[0],
          meta = _d[1];
      ...
      if (isFunction$1(children)) {
        return children(__assign({}, legacyBag, {
          meta: meta
        }));
      }
      ...
      if (typeof is === 'string') {
        ...
        return React.createElement(is, __assign({
          ref: innerRef
        }, field, rest), children);
      }

      return React.createElement(is, __assign({}, field, props), children);
    }
    var FastField = Field;
