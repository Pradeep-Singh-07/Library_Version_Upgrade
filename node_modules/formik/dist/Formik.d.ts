...
export declare function useFormik<Values = object>({ validateOnChange, validateOnBlur, isInitialValid, enableReinitialize, ...rest }: FormikConfig<Values>): {
    ...
    getFieldProps: <Val = any>(name: string, type: string) => [FieldInputProps<Val>, FieldMetaProps<Val>];
