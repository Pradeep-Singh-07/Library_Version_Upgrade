 ...
 */
export declare type ShutdownHandler = () => Promise<void> | void;
/**
...
export declare type BeaconContext = {
    [key: string]: unknown;
};
export declare type BeaconController = {
    readonly die: () => Promise<void>;
};
export declare type BlockingTask = Promise<unknown>;
export declare type State = 'SERVER_IS_NOT_READY' | 'SERVER_IS_NOT_SHUTTING_DOWN' | 'SERVER_IS_READY' | 'SERVER_IS_SHUTTING_DOWN';
/**
