...
async function build(dir, conf = null, reactProductionProfiling = false, debugOutput = false, runLint = true) {
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            const hasPages404 = (ref9 = mappedPages["/404"]) == null ? void 0 : ref9.startsWith(_constants.PAGES_DIR_ALIAS);
            ...
            const routesManifest = nextBuildSpan.traceChild("generate-routes-manifest").traceFn(()=>({
                    ...
                    staticRoutes: (0, _utils).getSortedRoutes(pageKeys).filter((page)=>!(0, _utils).isDynamicRoute(page) && !(0, _utils2).isReservedPage(page)).map(pageToRoute),
                    dataRoutes: [],
            ...
            if (result.errors.length > 0) {
                ...
                console.error();
                var _errors;
                const edgeRuntimeErrors = (_errors = (ref6 = result.stats[2]) == null ? void 0 : ref6.compilation.errors) != null ? _errors : [];
            ...
            const { customAppGetInitialProps , namedExports , isNextImageImported: isNextImageImported1 , hasSsrAmpPages: hasSsrAmpPages1 , hasNonStaticErrorPage ,  } = await staticCheckSpan.traceAsyncFn(async ()=>{
                ...
                const errorPageStaticResult = nonStaticErrorPageSpan.traceAsyncFn(async ()=>{
                    var ref, ref10;
                    return hasCustomErrorPage && staticWorkers.isPageStatic("/_error", distDir, isLikeServerless, configFileName, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) == null ? void 0 : ref.locales, (ref10 = config.i18n) == null ? void 0 : ref10.defaultLocale);
                });
                        ...
                        pageRuntime !== _constants.SERVER_RUNTIME.edge) {
                            try {
                                ...
                                let workerResult = await isPageStaticSpan.traceAsyncFn(()=>{
                                    var ref, ref11;
                                    return staticWorkers.isPageStatic(page, distDir, isLikeServerless, configFileName, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) == null ? void 0 : ref.locales, (ref11 = config.i18n) == null ? void 0 : ref11.defaultLocale, isPageStaticSpan.id);
                                });
            ...
            telemetry.record((0, _events).eventBuildOptimize(pagePaths, {
                ...
                hasReportWebVitals: (ref7 = namedExports == null ? void 0 : namedExports.includes("reportWebVitals")) != null ? ref7 : false,
            ...
            if (ssgPages.size > 0) {
                ...
                await generateClientSsgManifest(prerenderManifest, {
                    distDir,
                    buildId,
                    locales: ((ref8 = config.i18n) == null ? void 0 : ref8.locales) || []
                });
            } else {
                const prerenderManifest = {
                    version: 3,
            ...
            var _pathname;
            images.remotePatterns = ((config == null ? void 0 : (ref1 = config.experimental) == null ? void 0 : (ref2 = ref1.images) == null ? void 0 : ref2.remotePatterns) || []).map((p)=>({
