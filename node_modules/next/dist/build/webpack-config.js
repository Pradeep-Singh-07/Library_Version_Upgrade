...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target ="server" , appDir , middlewareRegex  }) {
    ...
    async function handleExternals(context, request, dependencyType, getResolve) {
        ...
        if (!isLocal) {
            ...
            const notExternalModules = /^(?:private-next-pages\/|next\/(?:dist\/pages\/|(?:app|document|link|image|future\/image|constants|dynamic|script)$)|string-hash$)/;
                    ...
                    new TerserPlugin({
                        ...
                        terserOptions: {
                            ...
                            compress: {
                                ...
                                ...(ref44 = (ref = config.experimental.swcMinifyDebugOptions) == null ? void 0 : ref.compress) != null ? ref44 : {}
                            },
                            mangle: {
                                ...terserOptions.mangle,
                                ...(ref45 = (ref43 = config.experimental.swcMinifyDebugOptions) == null ? void 0 : ref43.mangle) != null ? ref45 : {}
                            }
                        }
                    }).apply(compiler);
                },
        ...
        plugins: [
            ...
            new _webpack.webpack.DefinePlugin({
                ...
                "process.env.__NEXT_IMAGE_OPTS": JSON.stringify({
                    ...
                    experimentalUnoptimized: config == null ? void 0 : (ref1 = config.experimental) == null ? void 0 : (ref2 = ref1.images) == null ? void 0 : ref2.unoptimized,
                    experimentalFuture: (ref3 = config.experimental) == null ? void 0 : (ref4 = ref3.images) == null ? void 0 : ref4.allowFutureImage,
                    ...dev ? {
                        // pass domains in development to allow validating on the client
                        domains: config.images.domains,
                        experimentalRemotePatterns: (ref5 = config.experimental) == null ? void 0 : (ref6 = ref5.images) == null ? void 0 : ref6.remotePatterns
                    } : {}
                }),
                "process.env.__NEXT_ROUTER_BASEPATH": JSON.stringify(config.basePath),
                "process.env.__NEXT_HAS_REWRITES": JSON.stringify(hasRewrites),
                "process.env.__NEXT_I18N_SUPPORT": JSON.stringify(!!config.i18n),
                "process.env.__NEXT_I18N_DOMAINS": JSON.stringify((ref7 = config.i18n) == null ? void 0 : ref7.domains),
          ...
          `
            ...
            !dev && isClient && new (require("./webpack/plugins/telemetry-plugin")).TelemetryPlugin(new Map([
                ...
                [
                    "swcRelay",
                    !!((ref8 = config.compiler) == null ? void 0 : ref8.relay)
                ],
                [
                    "swcStyledComponents",
                    !!((ref9 = config.compiler) == null ? void 0 : ref9.styledComponents)
                ],
                [
                    "swcReactRemoveProperties",
                    !!((ref10 = config.compiler) == null ? void 0 : ref10.reactRemoveProperties), 
                ],
                [
                    "swcExperimentalDecorators",
                    !!(jsConfig == null ? void 0 : (ref11 = jsConfig.compilerOptions) == null ? void 0 : ref11.experimentalDecorators), 
                ],
                [
                    "swcRemoveConsole",
                    !!((ref12 = config.compiler) == null ? void 0 : ref12.removeConsole)
                ],
                [
                    "swcImportSource",
                    !!(jsConfig == null ? void 0 : (ref13 = jsConfig.compilerOptions) == null ? void 0 : ref13.jsxImportSource)
                ],
                [
                    "swcEmotion",
                    !!((ref14 = config.compiler) == null ? void 0 : ref14.emotion)
                ],
                SWCBinaryTarget, 
            ].filter(Boolean))), 
        ].filter(Boolean)
    ...
    if ((jsConfig == null ? void 0 : (ref15 = jsConfig.compilerOptions) == null ? void 0 : ref15.paths) && resolvedBaseUrl) {
        var ref29, ref30;
        (ref29 = webpackConfig.resolve) == null ? void 0 : (ref30 = ref29.plugins) == null ? void 0 : ref30.unshift(new _jsconfigPathsPlugin.JsConfigPathsPlugin(jsConfig.compilerOptions.paths, resolvedBaseUrl));
    }
    ...
    const cache = {
        ...
        version: `${"12.2.1-canary.1"}|${configVars}`,
    ...
    var ref36;
    const hasUserCssConfig = (ref36 = (ref24 = webpackConfig.module) == null ? void 0 : ref24.rules.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include))) != null ? ref36 : false;
    if (hasUserCssConfig) {
        var ref37, ref38, ref39, ref40;
        ...
        if ((ref37 = webpackConfig.module) == null ? void 0 : ref37.rules.length) {
...
function attachReactRefresh(webpackConfig, targetLoader) {
    ...
    (ref = webpackConfig.module) == null ? void 0 : ref.rules.forEach((rule)=>{
        const curr = rule.use;
