...
var propTypes = {
   ...
   * @private
   */
  children: _propTypes2.default.oneOfType([_propTypes2.default.element.isRequired, _propTypes2.default.func.isRequired]).isRequired
};
  ...
  function Position(props, context) {
    ...
    _this.onUpdate = function (_ref) {
      ...
      _this.setState({
        ...
        style: styles,
        position: {
          left: offsets.popper.left,
          top: offsets.popper.top
        },
